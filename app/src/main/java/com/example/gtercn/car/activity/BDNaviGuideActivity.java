 ...
 * @author sunhao04
 */
public class BDNaviGuideActivity extends Activity {

    private final String TAG = BDNaviGuideActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FourServeDetailActivity.activityList.add(this);
        createHandler();
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mStartNode = (BNRoutePlanNode) bundle.getSerializable("startNode");
                mEndNode = (BNRoutePlanNode) bundle.getSerializable("endNode");
            }
        }
        //显示自定义图标
        if (hd != null) {
    ...
    protected void onDestroy() {
        ...
        FourServeDetailActivity.activityList.remove(this);
...
//    }
    ...
    private void addCustomizedLayerItems() {
        ...
        if (mStartNode != null) {
            //坐标转换
            item1 = new CustomizedLayerItem(mStartNode.getLongitude(), mStartNode.getLatitude(),
                    mStartNode.getCoordinateType(), null,
                ...
                public void handleMessage(android.os.Message msg) {
                    if (msg.what == MSG_SHOW) {
                        ...
                        BNRouteGuideManager.getInstance().resetEndNodeInNavi(
                                new BNRoutePlanNode(mEndNode.getLongitude(), mEndNode.getLatitude(), "目的地", null, CoordinateType.BD09LL));
                    }
                }
